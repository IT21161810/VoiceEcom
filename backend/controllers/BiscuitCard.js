...
export const AddBiscuitCard = async(req,res) => {
    
    const {resturant,price,dish,rating,review,image} = req.body;
    ...
    try{
        ...
        const biscuitcard = new Cart({
            resturant,price,dish,rating,review,image,datecreated
        })
...
//get all biscut
export const getAllBiscuitCard = async(req,res) => {
...
//get single biscuit
export const SingleBiscuitCard = async (req, res) => {
...
//update biscut 
export const UpdateBiscutCard = async (req, res) => {
    const { id } = req.params;
    ...
    try {
        ...
        const updatebiscuitcard = await Cart.findByIdAndUpdate({ _id: id }, {
            ...
            resturant,price,dish,rating,review,image,dateUpdated
        }, {
            new: true
        })
...
//delete biscuit
export const DeleteBiscuit = async (req, res) => {
    ...
    return res.status(200).json({ message: "Biscuit Deleted Successfully" });
